FAIL	cover [setup failed]
	github.com/heldercruvinel/transactions-routine/cmd/api		coverage: 0.0% of statements
	github.com/heldercruvinel/transactions-routine/database/postgresql		coverage: 0.0% of statements
flag provided but not defined: -func
Usage of /tmp/go-build816683843/b206/accounts.test:
  -test.bench regexp
...
FAIL	github.com/heldercruvinel/transactions-routine/internal/accounts	0.002s
FAIL
